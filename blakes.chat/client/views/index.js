 ...
 */
var ctrl = new Blakes.ChatController();

/*
 * subscribe chat from server with criteria from controller and sort limit from controller
 * when template created
 */
Template.Blakes_chatIndex.onCreated(function() {
    var self = this;
    self.autorun(function() {
        self.subscribe('Blakes_chat', ctrl.getCriteria(), ctrl.getSortLimit());
    });
});

Template.Blakes_chatIndex.helpers({
...
Template.Blakes_chatIndex.events = {
